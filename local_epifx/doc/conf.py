...
# Combine the class and __init__ method docstrings.
autoclass_content = 'both'
...
rst_epilog = """
.. _epifx: http://bitbucket.org/robmoss/epidemic-forecasting-for-python
.. _pypfilt: http://pypfilt.readthedocs.io/
...
latex_documents = [
  ('index', 'epifx.tex', u'epifx documentation',
   u'Rob Moss', 'manual'),
]
...
man_pages = [
    ('index', 'epifx', u'epifx documentation',
     [u'Rob Moss'], 1)
]

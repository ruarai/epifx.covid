...
rst_epilog = """
.. _pypfilt: http://bitbucket.org/robmoss/particle-filter-for-python
.. _TOML: https://toml.io/
"""
...
latex_documents = [
  ('index', 'pypfilt.tex', u'pypfilt documentation',
   u'Rob Moss', 'manual'),
]
...
man_pages = [
    ('index', 'pypfilt', u'pypfilt documentation',
     [u'Rob Moss'], 1)
]
